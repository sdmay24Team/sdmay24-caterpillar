...
import { createCaretaker } from "../graphql/mutations";
const client = generateClient();
export default function CaretakerCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createCaretaker.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "CaretakerCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
